...
import { churches, members, ministers, ministerAwardsRecognitions, ministerCaseReports, ministerChildren, ministerEducationBackgrounds, ministerEmergencyContacts, ministerEmploymentRecords, ministerMinistryExperiences, ministryRanks, ministerMinistryRecords, ministerMinistrySkills, ministrySkills, ministerSeminarsConferences } from "./schema";
...
export const ministerAwardsRecognitionsRelations = relations(ministerAwardsRecognitions, ({one}) => ({
...
export const ministerCaseReportsRelations = relations(ministerCaseReports, ({one}) => ({
	minister: one(ministers, {
...
export const ministerChildrenRelations = relations(ministerChildren, ({one}) => ({
	minister: one(ministers, {
...
export const ministerEducationBackgroundsRelations = relations(ministerEducationBackgrounds, ({one}) => ({
	minister: one(ministers, {
...
export const ministerEmergencyContactsRelations = relations(ministerEmergencyContacts, ({one}) => ({
	minister: one(ministers, {
...
export const ministerEmploymentRecordsRelations = relations(ministerEmploymentRecords, ({one}) => ({
	minister: one(ministers, {
...
export const ministerMinistryExperiencesRelations = relations(ministerMinistryExperiences, ({one}) => ({
	minister: one(ministers, {
...
export const ministerMinistryRecordsRelations = relations(ministerMinistryRecords, ({one}) => ({
	minister: one(ministers, {
...
export const ministerMinistrySkillsRelations = relations(ministerMinistrySkills, ({one}) => ({
	minister: one(ministers, {
...
export const ministrySkillsRelations = relations(ministrySkills, ({many}) => ({
	ministerMinistrySkills: many(ministerMinistrySkills),
}));

export const ministerSeminarsConferencesRelations = relations(ministerSeminarsConferences, ({one}) => ({
	minister: one(ministers, {
